...
export const META_SERVICES: Record<number, MetaServiceInfo> = {
  ...
  11: { id: 11, name: "STATUS SET", frame: "T-2 -> status", description: "Status değerini T-2 hücresinden yükler." },
  12: { id: 12, name: "STATUS PRINT", frame: "none", description: "Status açıklamasını basar." },
  13: { id: 13, name: "ERR SET", frame: "none", description: "ERR bayrağını set eder (status=0 ise 1 yapar)." },
  14: { id: 14, name: "ERR RESET", frame: "none", description: "ERR bayrağını temizler (status=0)." },
  15: { id: 15, name: "ERR READ", frame: "T+1=err(0|1)", description: "ERR bayrağını sonuç hücresine yazar." },
  ...
  81: { id: 81, name: "ADD POINTER", frame: "P += T-1", description: "Pointer değerini arg2 kadar artırır." },
  82: { id: 82, name: "GET POINTER", frame: "P -> T+1", description: "Pointer değerini sonuç hücresine yazar." },
  83: { id: 83, name: "POINTER VALID", frame: "T+1", description: "Pointer geçerli aralıkta mı (0|1) döndürür." },
  ...
  87: { id: 87, name: "CELL BITS", frame: "T+1", description: "Aktif hücre bit genişliğini döndürür." },
  88: { id: 88, name: "CELL BYTES", frame: "T+1", description: "Aktif hücre byte boyutunu döndürür." },
